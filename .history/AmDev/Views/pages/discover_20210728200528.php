...
<div class="videos">
    <a feature="true" available="true" class="videos5" href="#">
        <i class="fa fa-pencil" aria-hidden="true"></i>
        <h1>Criadores</h1>
        <p>Conheça-nos. Saiba quem nós somos e o que pensamos para criar a plataforma.</p>
    </a>
</div>
...
<div class="videos">
    <a feature="true" available="true" class="videos6" href="#">
        <i class="fa fa-pencil" aria-hidden="true"></i>
        <h1>Plataforma</h1>
        <p>Conheça a plataforma, como foi criada, para o que foi criada, e o que almejamos atingir com ela.</p>
    </a>
</div>
