...
<div class="videos">
    <a feature="true" color="#E83F5B" available="true" class="videos1" href="<?php echo INCLUDE_PATH_STATIC ?>discover-pages/videos-iniciais-e-guias.php">
...
<div class="videos">
    <a feature="true" color="#E83F5B" available="true" class="videos4" href="#">
        <img src="<?php echo INCLUDE_PATH_STATIC ?>images/discover4.PNG" alt="Discover">
