...
<div class="corpo-discover">
    <div class="corpo-principal">
        <div class="discover-name">
                <img src="<?php echo INCLUDE_PATH_STATIC ?>images/logoamdev1.png" />
                <div class="botao-comunidade">
                    <a href="#"><button type="button" class="botao-discord">Comunidade</button></a>
                </div>
            </div>
...
<div class="videos">
    <a feature="true" color="#E83F5B" available="true" class="videos4" href="#">
        <i class="fa fa-pencil" aria-hidden="true"></i>
        <h1>Vídeos iniciais</h1>
        <p>Configure o seu ambiente de estudo com os vídeos iniciais da plataforma.</p>
    </a>
...
<div class="sobre-discover">
    ...
    <i class="fa fa-pencil" aria-hidden="true"></i>
    <h1>Criadores</h1>
    <p>Conheça-nos, os criadores da plataforma. Como nos conhecemos e como pensamos no desenvolvimento do projeto Discover.</p>
</div>
<div class="sobre-discover">
    <a feature="true" available="true" class="videos6" href="#">
    <i class="fa fa-pencil" aria-hidden="true"></i>
    <h1>Plataforma</h1>
    <p>Conheça quais os reais objetivos da plataforma, como e para que ela foi criada.</p>
</div>
