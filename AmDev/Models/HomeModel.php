	...
	class HomeModel{
		...
		public static function retrieveFriendsPosts(){
			...
			foreach ($amigosConfirmados as $key => $value) {
				$listaAmigos[$key]['id'] = \AmDev\Models\UsuariosModel::getUsuarioById($value)['id'];
				$listaAmigos[$key]['nome'] = \AmDev\Models\UsuariosModel::getUsuarioById($value)['nome'];
				$listaAmigos[$key]['email'] = \AmDev\Models\UsuariosModel::getUsuarioById($value)['email'];
				$listaAmigos[$key]['img'] = \AmDev\Models\UsuariosModel::getUsuarioById($value)['img'];
				$listaAmigos[$key]['ultimo_post'] = \AmDev\Models\UsuariosModel::getUsuarioById($value)['ultimo_post'];
			}
